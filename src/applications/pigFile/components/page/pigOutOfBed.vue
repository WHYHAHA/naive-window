    ...
    <div class="p-1">
        <div class="tabHeader font-16 font-weight-bolder">
            <n-space align="center">
                <div>{{ $t("dtables.listing.detailsOfMyBed") }}:</div>
                <n-date-picker
...
<script>
    ...
    import { getPigOutOfBedListApi } from "@/api/pigOutOfBed.js"
    ...
    export default defineComponent({
        ...
        setup(props) {
            ...
            const state = reactive({
                ...
                search: {
                    // 下床记录日期开始时间
                    outOfBedTimeGte: helper.formatStartTamp(
            ...
            const setTableColumns = () => {
                state.columns = [
                    ...
                    {
                        title: () => t("dataTable.listing.dateOfBed"),
                        key: "outOfBedDate",
                        render(row) {
                    ...
                    {
                        title: () => t("dataTable.listing.typeOfOutOfBed"),
                        key: "outBedType",
                        render(row) {
                    ...
                    {
                        title: () => t("dataTable.listing.inColumn"),
                        key: "inColumnCode"
                    },
                    {
