            ...
            <n-card title="登记配种">
                <n-grid x-gap="12" :cols="5">
                        ...
                        <div class="tabHeader font-16 font-weight-bolder">
                            <n-space justify="space-between">
                                <n-space align="center">
                                    <div>{{ $t("dtables.listing.breedingSowsListing") }}</div>
                                    <n-select
                    ...
                    <n-gi span="2 400:2 600:2 800:2">
                        <div class="tabHeader font-16 font-weight-bolder">
                            {{ $t("dtables.listing.breedingRegistrationForm") }}:
                        </div>
        ...
        setup() {
            ...
            const createColumns = ({ sendMail }) => {
                return [
                    ...
                    {
                        title: () => t("dataTable.listing.qestrusDate"),
                        key: "age"
                    },
                    {
                        title: () => t("dtables.listing.estrusEndDate"),
                        key: "age"
                    },
                    {
                    ...
                    {
                        title: () => t("dataTable.listing.semenCode"),
                        key: "age"
                    },
                    {
                        ...
                        render(row) {
                            return h(
                                ...
                                { default: () => t("dtables.listing.addedToTheRegistrationForm") }
                            )
                        }
                    }
                ]
