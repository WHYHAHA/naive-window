export default {
  ...
  'account.settings.help': 'help',
  'account.settings.menu': 'menu',
  'account.settings.menuMap.basic': 'basic',
  ...
  'account.settings.AppList': 'Application List',
  'account.settings.menuScroll': 'Slide the scroll wheel to move the menu',
