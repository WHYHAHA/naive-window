<template>
    ...
    <!-- 导出 -->
    <exportComponents fileName="耳样送检清单" :apiUrl="exportUrl" :search="{
            inspectionType:1,
            ...originData
        ...
        setup(props, { emit }) {
            ...
            let methods = {
                ...
                getDynamicTHead: params => {
                    ...
                    getMeasureOptionsApi({ tname, typeStatus: 2 }).then(async res => {
                        if (res.code == 0) {
                ...
                getPigInspectList: async () => {
                    getPmPigSamplCollect({ samplcollectType: 1 }).then(res => {
