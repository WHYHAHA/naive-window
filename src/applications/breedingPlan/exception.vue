<template>
    <div class="p-2 hybridization">
        <n-space vertical :size="20">
            ...
            <n-card :title="$t('dtables.listing.registrationOfChanges')">
                <n-grid x-gap="12" :cols="5">
                    ...
                    <n-gi span="2 400:2 600:2 800:2">
                        <div class="tabHeader font-16 font-weight-bolder">
                            {{ $t("dtables.listing.moveTheSowRegistrationForm") }}:
                        </div>
        ...
        setup() {
            ...
            const createColumns = ({ sendMail }) => {
                return [
                    ...
                    {
                        title: () => t("dtables.listing.group"),
                        key: "age"
                    },
                    {
                        title: () => t("dataTable.listing.breedingValue"),
                        key: "age"
                    },
                    {
                    ...
                    {
                        title: () => t("dataTable.listing.numberOfInsemination"),
                        key: "age"
                    },
                    {
                        title: () => t("dtables.listing.registrationOfChanges"),
                        key: "actions",
                        render(row) {
                            return h(
                                NButton,
                                ...
                                { default: () => t("dtables.listing.suspected") }
                            )
                        }
                    }
                ]
            ...
            const createColumns2 = ({ sendMail }) => {
                return [
                    {
                        title: () => t("dtables.listing.moveTheSowEncoding"),
                        key: "name",
                        align: "center"
                    },
                    {
                    ...
                    {
                        title: () => t("dtables.listing.moveType"),
                        key: "age"
                    },
                    {
