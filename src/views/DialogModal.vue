<template>
    <div class="dialog-container">
        ...
        <transition enter-active-class="animated zoomIn" leave-active-class="animated zoomOut" @after-leave="onAfter" @after-appear="onBefore">
            <div class="dialog-modal" v-show="display" :class="{'inside': this.inside}" :style="{  width: this.width + 'px' }">
                ...
                <div class="dialog-footer">
                    <div>
                        ...
                        <button type="button" class="dogstar-btn dogstar-btn-primary" @click="onOk">
                            <span>
                                按
                                钮
                            </span>
